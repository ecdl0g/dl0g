// Copyright (c) 2018-2022 The DL0G Core developers
...
//! Entry point for DL0GApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &DL0GApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for DL0GGUI tests.
void AppTests::guiTests(DL0GGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &DL0GGUI::consoleShown, this, &AppTests::consoleTests);
