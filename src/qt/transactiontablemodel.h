...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, DL0GUnits::SeparatorStyle separators=DL0GUnits::SeparatorStyle::STANDARD) const;
