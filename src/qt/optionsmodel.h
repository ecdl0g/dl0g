...
/** Interface from Qt to configuration data structure for DL0G client.
...
public:
    ...
    DL0GUnit getDisplayUnit() const { return m_display_bitcoin_unit; }
...
private:
    ...
    QString language;
    DL0GUnit m_display_bitcoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(DL0GUnit unit);
