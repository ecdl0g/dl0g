...
/**
  DL0G GUI main class. This class represents the main window of the DL0G UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DL0GGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit DL0GGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~DL0GGUI();
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, DL0GUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed DL0G Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(DL0GUnit newUnits);
