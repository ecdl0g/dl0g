...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = DL0GUnits::formatWithUnit(unit, amount, true, DL0GUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const interfaces::WalletBalances& balances)
{
    ...
    ui->labelBalance->setText(DL0GUnits::formatWithPrivacy(unit, balances.balance, DL0GUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(DL0GUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, DL0GUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(DL0GUnits::formatWithPrivacy(unit, balances.immature_balance, DL0GUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(DL0GUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, DL0GUnits::SeparatorStyle::ALWAYS, m_privacy));
